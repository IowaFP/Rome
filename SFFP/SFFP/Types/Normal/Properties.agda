module SFFP.Types.Normal.Properties where
...
import SFFP.Types.Properties as TypeProps
open TypeProps using (↑-cong ; ↑-id ; ↑-comp)
open import SFFP.Types.Renaming using (Renaming ; _≈_ ; ↑)

open import SFFP.Types.Normal
