...
\begin{array}{r@{\hspace{5px}}l@{\qquad}r@{\hspace{5px}}l@{\qquad}r@{\hspace{5px}}l@{\qquad}r@{\hspace{5px}}l}
  \text{Term variables} & x & \text{Type variables} & \alpha & \text{Nat variables} & n
\end{array}
\\[5px]
\begin{doublesyntaxarray}
  \mcl{\text{Nat}} & N & ::= & n \mid \Zero \mid \Suc \, N \\
  \mcl{\text{Kinds}} & \kappa & ::= & \Nat \mid \Ix{N} \mid  \TypeK \mid \kappa \to \kappa \\
  \text{Types} & \mcr{\tau, \upsilon} & ::= & \Nat \mid \Ix{N} \mid \top \mid \alpha \mid (\to) \mid \forall \alpha\co\kappa. \tau \mid  \exists \alpha\co\kappa. \tau \mid \lambda \alpha\co\kappa. \tau \mid \tau \, \tau \\
  \mcl{\text{Terms}} & M, N & ::= & x \mid \lambda x \co \tau. M \mid M \, N \mid \Lambda \alpha \co \kappa. M \mid \AppT M \tau \mid ... \\
  \mcl{\text{Environments}} & \Gamma & ::= & \varepsilon \mid \Gamma, n : N \mid \Gamma, \alpha : \kappa \mid \Gamma, x : \tau
