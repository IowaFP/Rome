...
\begin{doublesyntaxarray}
  ...
  \mcl{\text{Terms}} & M, N & ::= & x \mid \star \mid \Nat \mid \Zero \mid \Suc \, M \mid \\
  & & & & \Ix{M} \mid \FZero \mid \FSuc \; M \mid \\
  & & & &  \top \mid \tt \mid \\
  & & & &  \Pi \alpha \co M. N \mid \lambda x \co M. N \mid M \, N \mid \\
  & & & &  \Sigma \alpha \co M. M \mid (\alpha \co M , M) \mid M.1 \mid M.2  \\
  & & & &  M + N \mid \left\, M \mid \right\, M \mid \Case M M M \\
  & & & &  M \equiv N \mid \Refl \mid ... \\
  \mcl{\text{Environments}} & \Gamma & ::= & \varepsilon \mid \Gamma, \alpha : M
...
\rsp
\ib{\irule{\SortJ \Gamma {M_1} {N_1}}{\SortJ \Gamma {N_1} {\sigma_1}}{\SortJ \Gamma {M_2} {N_2}}{\SortJ \Gamma {N_2} {\sigma_2}};{\SortJ \Gamma {{M_1} \equiv {M_2}} {\star}}}
\end{gather*}
