...
\title{When in Rome; Or,}
\subtitle{Practical extensibility in recursive row type theory}
...
\begin{itemize}
\item $\Gamma \vdash \tau \leadsto \upsilon : \kappa$ denotes the translation of judgment $\Gamma \vdash \tau : \kappa$ to term $\Ixed{\Gamma} \vdash \upsilon : \Ixed{\kappa}$.
\item 
\end{itemize}
