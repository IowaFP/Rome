...
liftₖ-cong : ∀ {r₁ r₂ : Renamingₖ Δ₁ Δ₂} → (∀ {ι} {κ : Kind ι} (x : TVar Δ₁ κ) → r₁ x ≡ r₂ x) → 
...
renₖ-cong :  ∀ {r₁ r₂ : Renamingₖ Δ₁ Δ₂} →  (∀ {ι} {κ : Kind ι} (x : TVar Δ₁ κ) → r₁ x ≡ r₂ x) → 
              (τ : Type Δ₁ κ) → renₖ r₁ τ ≡ renₖ r₂ τ
renRowₖ-cong : ∀ {r₁ r₂ : Renamingₖ Δ₁ Δ₂} →  (∀ {ι}{κ : Kind ι} (x : TVar Δ₁ κ) → r₁ x ≡ r₂ x) → 
                  (xs : SimpleRow (Type Δ₁ κ)) → renRowₖ r₁ xs ≡ renRowₖ r₂ xs
renPredₖ-cong : ∀ {r₁ r₂ : Renamingₖ Δ₁ Δ₂} →  (∀ {ι}{κ : Kind ι} (x : TVar Δ₁ κ) → r₁ x ≡ r₂ x) → 
                  (π : Pred (Type Δ₁ R[ κ ])) → renPredₖ r₁ π ≡ renPredₖ r₂ π
                  
renₖ-cong eq (` x) rewrite eq x = refl
renₖ-cong eq (`λ τ)  = cong `λ (renₖ-cong (liftₖ-cong eq) τ)
...
renRowₖ-id : ∀ (ρ : SimpleRow (Type Δ κ)) → renRowₖ id ρ ≡ ρ
...
renRowₖ-comp : ∀ (r₁ : Renamingₖ Δ₁ Δ₂) (r₂ : Renamingₖ Δ₂ Δ₃) → 
                ∀ (ρ : SimpleRow (Type Δ₁ κ)) → renRowₖ (r₂ ∘ r₁) ρ ≡ renRowₖ r₂ (renRowₖ r₁ ρ)
...
renₖ-comp r₁ r₂ (l ▹ τ) = cong₂ _▹_ (renₖ-comp r₁ r₂ l) (renₖ-comp r₁ r₂ τ)
...
↻-liftₖ-weaken : ∀ {κ' : Kind ι} (r : Renamingₖ Δ₁ Δ₂) (τ : Type Δ₁ κ) → 
...
↻-ren-map : ∀ (r : Renamingₖ Δ₁ Δ₂) (F : Type Δ₁ (κ₁ `→ κ₂)) (ρ : SimpleRow (Type Δ₁ κ₁)) → 
