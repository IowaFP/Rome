...
renRowₖ-cong eq ((l , τ) ∷ xs) rewrite renₖ-cong eq τ | renRowₖ-cong eq xs = refl
...
renRowₖ-id [] = refl
renRowₖ-id ((l , τ) ∷ xs) rewrite renₖ-id τ | renRowₖ-id xs = refl
...
renRowₖ-comp r₁ r₂ ((l , τ) ∷ r) rewrite 
