...
-- --   where
-- --     Unif-F : ∀ {k₁ k₂} (l : NormalType Δ₁ L) (F : KripkeFunction Δ₁ k₁ k₂) → Uniform (renKripke ρ (λ ρ' v → π (N.ren ρ' l ▹V F ρ' v)))
-- --     Unif-F {★} l F ρ₁ ρ₂ V₁ V₂ refl = trans-≋ ((↻-ren-π ρ₂ (N.ren (λ x → ρ₁ (ρ x)) l ▹V F (λ x → ρ₁ (ρ x)) V₁))) (cong-π {! ↻-renSem-eval (ρ₁ ∘ ρ) ((⇑ l) ▹ (⇑ (reify ( right F))))   !})
-- --     Unif-F {L} ρ₁ ρ₂ V₁ V₂ x = {!   !}
