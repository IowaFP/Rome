...
fundComplete : ∀ {τ₁ τ₂ : Type Δ₁ κ} {η₁ η₂ : Env Δ₁ Δ₂} → 
       Env-≋ η₁ η₂ → τ₁ ≡t τ₂ → eval τ₁ η₁ ≋ eval τ₂ η₂
fundCompletePred : ∀ {π₁ π₂ : Pred Δ₁ R[ κ ]} {η₁ η₂ : Env Δ₁ Δ₂} → 
            Env-≋ η₁ η₂ → π₁ ≡p π₂ → evalPred π₁ η₁ ≡ evalPred π₂ η₂

fundCompletePred e (τ₁ eq-≲ τ₂) = cong₂ _≲_ (reify-≋ (fundComplete e τ₁)) (reify-≋ (fundComplete e τ₂))
fundCompletePred e (τ₁ eq-· τ₂ ~ τ₃) rewrite
    reify-≋ (fundComplete e τ₁) 
  | reify-≋ (fundComplete e τ₂) 
  | reify-≋ (fundComplete e τ₃) = refl

fundComplete {τ₁ = τ} e eq-refl = idext e τ
fundComplete e (eq-sym eq) = sym-≋ (fundComplete (sym-≋ ∘ e) eq)
fundComplete e (eq-trans eq₁ eq₂) = trans-≋ (fundComplete (refl-≋ₗ ∘ e) eq₁) (fundComplete e eq₂)
fundComplete e (eq-→ {τ₁ = τ₁} {υ₁ = υ₁} eq-τ eq-υ) = cong₂ _`→_ (fundComplete e eq-τ) (fundComplete e eq-υ)
fundComplete {κ = κ} e (eq-· eq₁ eq₂) = cong-App (fundComplete e eq₁) (fundComplete e eq₂)
fundComplete e (eq-∀ eq) = cong (`∀ _) (fundComplete (extend-≋ (ren-≋ S ∘ e) (reflect-≋ refl)) eq)
fundComplete {η₁ = η₁} {η₂} e (eq-μ {τ = τ} {υ} eq) with eval τ η₁ | eval υ η₂ | fundComplete e eq
... | y | y₁ | Unif-F , Unif-G , Ext = cong μ (cong `λ (Ext S refl))
fundComplete e (eq-⌊⌋ eq) rewrite fundComplete e eq = refl
fundComplete e (eq-λ {τ = τ} {υ = υ} eq) = 
    (λ ρ₁ ρ₂ V₁ V₂ q → trans-≋ 
    ...
    λ ρ q → fundComplete (extend-≋ (λ x → ren-≋ ρ (e x)) q) eq
fundComplete {η₁ = η₁} {η₂ = η₂} e (eq-η {f = f}) = 
  fst (idext e f) , 
...
fundComplete {η₁ = η₁} {η₂ = η₂} e (eq-β {τ₁ = τ₁} {τ₂}) = 
    trans-≋ 
        (idext 
        ...
        (sym-≋ 
            (trans-≋ 
                ...
                (idext (λ { Z → idext (refl-≋ₗ ∘ e) τ₂
                          ; (S x) → (refl-≋ₗ ∘ e) x }) τ₁)))
fundComplete e (eq-▹ eq-l eq-τ) rewrite fundComplete e eq-l = cong-▹ refl (fundComplete e eq-τ)
fundComplete e (eq-⇒ eq-π eq-τ) = cong₂ _⇒_ (fundCompletePred e eq-π) (fundComplete e eq-τ)
fundComplete {κ = R[ κ ]} {η₁ = η₁} {η₂ = η₂} e (eq-Π▹ {l = l} {τ}) = (idext e l) , cong-π {τ₁ = eval τ η₁} {τ₂ = eval τ η₂} (idext e τ)
fundComplete {κ = R[ κ ]} {η₁ = η₁} {η₂ = η₂} e (eq-Σ▹ {l = l} {τ}) = (idext e l) , cong-σ {τ₁ = eval τ η₁} {τ₂ = eval τ η₂} (idext e τ)
-- clean this shit up
fundComplete {η₁ = η₁} {η₂ = η₂} e (eq-Πλ {κ₁ = κ₁} {κ₂ = κ₂} {l = l} {τ = τ}) = 
    (λ ρ₁ ρ₂ V₁ V₂ q → 
    trans-≋ 
        (↻-renSem-π ρ₂ 
...
fundComplete {η₁ = η₁} {η₂ = η₂} e (eq-Σλ {l = l} {τ = τ}) = 
    (λ ρ₁ ρ₂ V₁ V₂ q → 
    trans-≋ 
        (↻-renSem-σ ρ₂ 
            (renₖNF ρ₁ (eval l η₁) ▹V eval τ (extende _ (renSem id V₁))) 
    ...
    cong-σ 
        ((trans 
            ...
            (sym (trans 
                ...
                (idext (ren-≋ ρ ∘ refl-≋ᵣ ∘ e) l)))) ,
        idext (extend-≋ (ren-≋ ρ ∘ e) (renSem-id-≋ v)) τ)
fundComplete {η₁ = η₁} {η₂} e (eq-▹$ {l = l} {τ} {F}) = 
    (idext e l) , 
    cong-App 
      {V₁ = eval F η₁} 
      {V₂ = eval F η₂} 
      ...
      {W₂ = eval τ η₂} 
      (idext e τ)
fundComplete {κ = κ} {η₁ = η₁} {η₂} e (eq-Π-assoc {κ₁ = κ₁} {κ₂ = κ₂} {ρ = ρ} {τ}) with eval ρ η₁ | eval ρ η₂ | idext e ρ
...
fundComplete {κ = κ} {η₁ = η₁} {η₂} e (eq-Σ-assoc {κ₁ = κ₁} {κ₂ = κ₂} {ρ = ρ} {τ}) with eval ρ η₁ | eval ρ η₂ | idext e ρ
... | just (right (l , F)) | just (right (.l , G)) | refl , q rewrite 
      renₖNF-id l 
    | renSem-id {κ = κ₁ `→ κ₂} F 
...
fundComplete {κ = κ} {η₁ = η₁} {η₂} e (eq-Π {τ = τ}) with eval τ η₁ | eval τ η₂ | idext e τ 
... | just (left _) | just (left _) | refl = refl
... | just (right (l , τ)) | just (right (_ , υ)) | refl , q = refl , (cong-π q)
... | nothing | nothing | _ = tt
fundComplete {κ = κ} {η₁ = η₁} {η₂} e (eq-Σ {τ = τ}) with eval τ η₁ | eval τ η₂ | idext e τ 
... | just (left _) | just (left _) | refl = refl
... | just (right (l , τ)) | just (right (_ , υ)) | refl , q = refl , (cong-σ q)
... | nothing | nothing | _ = tt
fundComplete {κ = κ} {η₁ = η₁} {η₂} e (eq-<$> t u) = cong-<$> (fundComplete e t) (fundComplete e u)
fundComplete {κ = κ} {η₁ = η₁} {η₂} e eq-<$>ε = tt 

idEnv-≋ : ∀ {Δ} → Env-≋ (idEnv {Δ}) (idEnv {Δ})
idEnv-≋ x = reflect-≋ refl

completeness : ∀ {τ₁ τ₂ : Type Δ κ} → τ₁ ≡t τ₂ → ⇓ τ₁ ≡ ⇓ τ₂
completeness eq = reify-≋ (fundComplete idEnv-≋ eq)  
