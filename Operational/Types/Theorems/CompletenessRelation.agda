...
reify-≋ {κ = κ₁ `→ κ₂} {right F} {right  G}
  ( unif-F , ( unif-G ) ) = cong `λ (reify-≋  {!!}) -- (ext S (reflectNE-≋ refl))
...
reify-≋ {κ = R[ κ `→ κ₁ ]} {right (l₁ , right F)} {right (l₂ , right G)} (refl , unif-F , unif-G) = 
...
App-≋ {κ₁ = κ₁} {★} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = κ₁} {L} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = ★} {κ₂ `→ κ₃} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = L} {κ₂ `→ κ₃} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = κ₁ `→ κ₄} {κ₂ `→ κ₃} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = R[ κ₁ ]} {κ₂ `→ κ₃} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
App-≋ {κ₁ = κ₁} {R[ κ₂ ]} {V₁ = right F} {right G} (unif-F , unif-G) q = {!!}
...
ren-≋ {κ = κ₁ `→ κ₂} {V₁ = right F} {right G} ρ₁ (unif-F , unif-G) = 
...
Unif-F-NE : ∀ (l : NormalType Δ L) (f : NeutralType Δ (κ₁ `→ κ₂)) → Uniform (λ ρ' v → π (N.ren ρ' l ▹V reflectNE (renNE ρ' f · reify v)))
