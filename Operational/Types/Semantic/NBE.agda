...
π {κ = ★} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (ne x) ρ η = πNE x
π {κ = ★} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (row r) ρ η = Π r
π {κ = L} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (ne x) ρ η = πNE x
π {κ = L} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (row r) ρ η = ΠL r
π {κ = κ₁ `→ κ₂} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = πNE x
...
π {κ = R[ R[ κ ] ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = πNE x
...
σ {κ = ★} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (ne x) ρ η = ne (Σ x)
σ {κ = ★} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (row r) ρ η = Σ r
σ {κ = L} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (ne x) ρ η = ne (Σ x)
σ {κ = L} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (row r) ρ η = ΣL r
σ {κ = κ₁ `→ κ₂} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = left (Σ x)
σ {κ = κ₁ `→ κ₂} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , left f)) ρ η = right (λ ρ' v → σ (ren ρ' l ▵ reflectNE ((renNE ρ' f) · (reify v)))  (ρ' ∘ ρ) η)
σ {κ = κ₁ `→ κ₂} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , right F)) ρ η = right (λ ρ' v → σ (ren ρ' l ▵ F ρ' v)  (ρ' ∘ ρ) η)
σ {κ = R[ ★ ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = σNE x
σ {κ = R[ ★ ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , τ)) ρ η = row (l ▹ (reify (σ {κ = ★} τ ρ η)))
σ {κ = R[ L ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = σNE x
σ {κ = R[ L ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , τ)) ρ η = row (l ▹ (reify (σ {κ = L} τ ρ η)))
σ {κ = R[ κ₁ `→ κ₂ ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = σNE x
σ {κ = R[ κ₁ `→ κ₂ ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , left τ)) ρ η = _▵_ {κ = κ₁ `→ κ₂} l (σNE {κ = κ₁ `→ κ₂} τ)
σ {κ = R[ κ₁ `→ κ₂ ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , τ)) ρ η = _▵_ {κ = κ₁ `→ κ₂} l (σ {κ = κ₁ `→ κ₂} τ id idEnv)
σ {κ = R[ R[ κ ] ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (left x) ρ η = σNE x
σ {κ = R[ R[ κ ] ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , left τ)) ρ η = _▵_ {κ = R[ κ ]} l (σNE {κ = R[ κ ]} τ)
σ {κ = R[ R[ κ ] ]} {Δ₁ = Δ₁} {Δ₂} {Δ₃} (right (l , τ)) ρ η =  _▵_ {κ = R[ κ ]} l (σ {κ = R[ κ ]} τ id idEnv)
...
----------------------------------------
-- Type constants
eval {κ = κ₁ `→ κ₂} Π η = right (λ {Δ₃} ρ v → π v ρ η)
eval {κ = κ₁ `→ κ₂} Σ η = right (λ {Δ₃} ρ v → σ v ρ η) 
