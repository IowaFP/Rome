...
renSem {κ = R[ κ ]} r (left (left x)) = left (left (renₖNE r x))
renSem {κ = R[ κ ]} r (left (right (l , τ))) = left (right ((renₖNEapp r l) , (renSem r τ)))
...
orderedRenRow {n = suc (suc n)} {P} r (l₁<l₂ , o) =  l₁<l₂  , (orderedRenRow {n = suc n} {P ∘ fsuc} r o) -- l₁<l₂ , 
