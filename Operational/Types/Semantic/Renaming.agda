...
renSem {κ = R[ κ ]} ρ (left x) = left (renNE ρ x)
renSem {κ = R[ κ ]} ρ (right (l , τ)) = right (ren ρ l , renSem ρ τ)
...
renSem-id {κ = R[ κ ]} (left x) = cong left (ren-id-ne x) -- ren-id-ne x
renSem-id {κ = R[ κ ]} (right (l , τ)) = cong right (cong₂ _,_ (ren-id l) (renSem-id τ)) -- ren-id-ne x
