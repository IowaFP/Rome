...
open import Rome.Operational.Types.Properties.Renaming using (liftₖ-cong ; liftₖ-id ; liftₖ-comp)
open import Rome.Operational.Types.Renaming using (Renamingₖ ; _≈_ ; liftₖ)
...
renₖNF-cong eq (π ⇒ τ) rewrite 
  ...
  | renₖNF-cong eq τ = refl  
renₖNF-cong eq (`∀ κ τ) rewrite 
  renₖNF-cong (liftₖ-cong eq) τ = refl 
renₖNF-cong eq (μ τ) rewrite renₖNF-cong eq τ = refl
renₖNF-cong eq Unit = refl
...
-- renₖNF-id-row : ∀ (r : Row Δ R[ κ ]) → renRow id r ≡ r
...
renₖNF-id (ne ν g) rewrite renₖNE-id ν = refl
...
renₖNF-comp ρ₁ ρ₂ (ne ν g) rewrite renₖNE-comp ρ₁ ρ₂ ν  = refl
...
renₖNF-comp ρ₁ ρ₂ (π ⇒ τ) rewrite
  ...
  | renₖNF-comp ρ₁ ρ₂ τ = refl  
renₖNF-comp ρ₁ ρ₂ (`∀ κ τ) rewrite
  (trans (renₖNF-cong (liftₖ-comp ρ₁ ρ₂) τ) (renₖNF-comp (liftₖ ρ₁) (liftₖ ρ₂) τ)) = refl
renₖNF-comp ρ₁ ρ₂ (μ τ) rewrite renₖNF-comp ρ₁ ρ₂ τ = refl
renₖNF-comp ρ₁ ρ₂ Unit = refl
...
-- renₖNF-comp-row ρ₁ ρ₂ (l ▹ τ) rewrite renₖNF-comp ρ₁ ρ₂ l | renₖNF-comp ρ₁ ρ₂ τ = refl
